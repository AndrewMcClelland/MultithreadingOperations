...
// This implements the first matrix vector multiplication approach in which all threads are involved in computing each element of the output vector P, before moving onto the next output vector element
void main()
{
	int i, j;
